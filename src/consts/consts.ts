...
const getNftAddress = () => {
  ...
  switch (environment) {
    case 'production':
      ...
      break;
    case 'test':
      nftAddress = '0x5Ef4da0A49D5Ec55025E947991Dd2f0E3a375Ed2';
      break;
    case 'development':
    default:
